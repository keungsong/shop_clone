...
import 'package:shop_clone/screens/account_screen.dart';
import 'package:shop_clone/screens/chat_screen.dart';
import 'package:shop_clone/screens/forms/seller_form.dart';
import 'package:shop_clone/screens/home_screen.dart';
import 'package:shop_clone/screens/my_ad_screen.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:PageStorage(child: _currentScreen,
      bucket: _bucket,),
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          Navigator.pushNamed(context, SellerFormScreen.id);
        },
        child: CircleAvatar(
               ...
               MaterialButton(
                 ...
                 child: Column(
                   ...
                   children:[
                     ...
                     Text('Chat',style: TextStyle(color:_index==1 ? color:Colors.black,
               ...
               MaterialButton(
                 ...
                 child: Column(
                   ...
                   children:[
                     ...
                     Text('My Ads',style: TextStyle(color:_index==2 ? color:Colors.black,
               ...
               MaterialButton(
                 ...
                 child: Column(
                   ...
                   children:[
                     ...
                     Text('Account',style: TextStyle(color:_index==3 ? color:Colors.black,
